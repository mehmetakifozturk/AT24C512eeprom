...
Serial.println(data_out.databyte);
Serial.println(data_out.datadouble);
Serial.println(data_out.dataint);
Serial.println(data_out.str);
///// other data types //////////////////////////
